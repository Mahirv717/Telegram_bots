...
BOT_TOKEN: str = os.getenv("8760641589:AAF-qPAERkcKTdWo92tTqAO_TpQsLRKfbEA")

# Telegram user ID of the ONE admin allowed to control the bot.
ADMIN_ID: int = int(os.getenv("ADMIN_ID", "8810506068"))

# The channel where giveaway posts (start/winner announcement) are sent.
# Can be a numeric chat id (e.g. -1004491942893) or a public @username.
GIVEAWAY_CHANNEL_ID: str = os.getenv("-1004491942893", "@gelmicem")
